...
[![Tests](https://img.shields.io/badge/tests-264%20passed-brightgreen.svg)](https://github.com/gabiviana93/telco_churn_clients/actions)
[![Coverage](https://img.shields.io/badge/coverage-74%25-green.svg)](https://github.com/gabiviana93/telco_churn_clients/actions)
...
- **Testing**: 264 testes pytest com 74% coverage
...
│
├── tests/                        # Suite de testes (264 testes, 74% coverage)
...
```bash
# Executar todos os testes (264 testes)
poetry run pytest
...
**264 testes** (74% coverage) cobrindo:
